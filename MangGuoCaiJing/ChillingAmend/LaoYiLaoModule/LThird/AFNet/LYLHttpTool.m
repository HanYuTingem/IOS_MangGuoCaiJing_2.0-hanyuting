...
+ (NSString *)logingUserDumplingWithUserId:(NSString *)userId productCode:(NSString *)productCode sysType:(NSString *)sysType andSessionValue:(NSString *)sessionValue{
    NSMutableDictionary *mutDic = [NSMutableDictionary dictionary];
    [mutDic setObject:userId forKey:@"userId"];
    [mutDic setObject:productCode forKey:@"productCode"];
    [mutDic setObject:sysType forKey:@"sysType"];
...
+ (NSString *)myDumplingWithProductCode:(NSString *)productCode sysType:(NSString *)sysType andSessionValue:(NSString *)sessionValue UserId:(NSString*)userId{
    NSMutableDictionary *mutDic = [NSMutableDictionary dictionary];
    [mutDic setObject:userId forKey:@"userId"];
    [mutDic setObject:productCode forKey:@"productCode"];
    [mutDic setObject:sysType forKey:@"sysType"];
