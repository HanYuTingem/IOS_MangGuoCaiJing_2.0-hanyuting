...
#define IsStrWithNUll(str) [str isEqualToString:@""] || !str 
...
#define LoginStateKey @"LoginStateKey"//登陆还是未登陆的key
#define LogingState MyObjectForKey(LoginStateKey)//登录状态
#define LoginStateYES @"1"//已登录
#define LoginStateNO @"0"//未登录

#define LoginPhoneKey @"LoginPhoneKey"//登录人手机号
...
#define ProductCode @"bd9ee297-69ec-46c8-9a29-1b8782d2dba9"   //产品标识
