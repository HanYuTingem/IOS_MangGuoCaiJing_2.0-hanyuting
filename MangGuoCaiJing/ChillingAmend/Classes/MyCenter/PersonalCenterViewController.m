...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    // 界面scrollview大小
    [_personalCenterScrollView setContentSize:CGSizeMake(self.view.frame.size.width, 685-45*3)];
...
- (IBAction)personQianBao:(UIButton *)sender {
    //NSLog(@"你点击了我的钱包");
    ...
    mineWalletViewController* mineWallet = [[mineWalletViewController alloc] init];
    //mineWallet.type = @""
    [self.appDelegate.homeTabBarController hideTabBarAnimated:YES];
    [self.navigationController pushViewController:mineWallet animated:YES];
...
- (IBAction)loginOutAction:(id)sender
{
    ...
    //MySetObjectForKey(LoginStateNO, LoginStateKey);//设置已经登录
