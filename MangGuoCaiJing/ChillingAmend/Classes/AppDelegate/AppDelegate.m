...
#define UMengAppKey @"56610d70e0f55a53c100372a"
...
//    [LYLTools startMonitoring];
    ...
    if (!CityName) {
        [[NSUserDefaults standardUserDefaults] setObject:@"湖南" forKey:@"CityName"];
    }
...
- (void)UMShareMethod{
    ...
    NSArray * sharePlatformArray = @[UMShareToWechatSession,UMShareToWechatTimeline,UMShareToQQ,UMShareToQzone];
