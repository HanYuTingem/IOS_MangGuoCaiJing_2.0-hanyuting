...
//    [UMSocialData defaultData].extConfig.wechatSessionData.title = @"来自天天乐玩APP客户端";
    ...
    [UMSocialData defaultData].extConfig.qzoneData.title = @"来自芒果财经APP客户端";
    [UMSocialData defaultData].extConfig.qqData.title = @"来自芒果财经APP客户端";
    [UMSocialData defaultData].extConfig.wechatSessionData.title = @"来自芒果财经APP客户端";
...
//    [UMSocialWechatHandler setWXAppId:@"wx08d78379377cc3e8" appSecret:@"f8052085ce493a6c6caf50199b3ef80a" url:idStr];
    [UMSocialWechatHandler setWXAppId:@"wx21679c4c27df0061" appSecret:@"d4624c36b6795d1d99dcf0547af5443d" url:idStr];
    //设置分享到QQ空间的应用Id，和分享url 链接
//    [UMSocialQQHandler setQQWithAppId:@"1103967875" appKey:@"SOETiOBnRcnlY3Jd" url:idStr];
    [UMSocialQQHandler setQQWithAppId:@"1104975154" appKey:@"NuR59hoLWPjfKQDd" url:idStr];
    NSString *contentTitle = @"";
    if ([content isEqualToString:@""]) {
//        contentTitle = @"天天乐玩是最火爆的电视、观众互动神器，多种互动玩法，瞬间收礼收到爆！马上注册天天乐玩，和我一起赢取丰富奖品呦~~。加下载微门户地址（点击进入下载微门户页面，页面上有当前用户的唯一邀请码）。";
        contentTitle = [NSString stringWithFormat:@"%@ %@ %@",title,@"芒果财经 湖南人的生活娱乐电商平台",idStr];
    }else{
        //设置分享内容
