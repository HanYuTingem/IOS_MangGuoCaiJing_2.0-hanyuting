...
- (void)downLodendData{
    NSDictionary *parameter = @{@"couponId":_couponId,@"proIden":PROIDEN,@"oId":LYUserId,@"phone":PhoneNumber};
...
//        [self showMsg:@"优惠券已领取"];
//    }
    NSDictionary *parameter = @{@"oId":LYUserId,@"couponId":_couponId,@"phone":PhoneNumber,@"ownerId":self.ownerId};
