...
//        }
        ...
        list.oId  = [NSString stringWithFormat:@"%@",LYUserId];
...
- (void)startDownLoad
{
    ...
    NSDictionary *parameter = @{@"oId":LYUserId,@"proIden":PROIDEN,@"seatId":self.seatId};
...
- (void)startCancelBookSeatDownLoad
{
    [self showStartHud];
    NSString * str  = [NSString stringWithFormat:@"%@",NFM_URL];
    NSDictionary *parameter = @{@"oId":LYUserId,@"seatId":[NSString stringWithFormat:@"%@",self.seatId],@"proIden":PROIDEN};//@"ownerId":@""
