...
-(void)getMerchantData{
    [self showStartHud];
    NSString * str  = [NSString stringWithFormat:@"%@",NFM_URL];
    NSDictionary *parameter = @{@"ownerId":_ownerId,@"oId":LYUserId,@"proIden":PROIDEN};
...
-(void)clickCollectionBtn:(BottomBtn*)btn{
    ...
    NSDictionary * parameter = @{@"ownerId":self.ownerId,@"oId":LYUserId,@"deleteFlag":deleteFlag};
