...
- (void)clickSexButton:(SelectButton *)button{
    if (button.selected == YES) {
        ...
        _tempButton = button;
        _sexIndex = [NSString stringWithFormat:@"%d", button.tag % 2];
    }
}
...
- (void)requestData{
    ...
    NSDictionary *dic = [Parameter getTakeoutSettlementInfoWithOId:LYUserId ownerId:_ownerId totalprice:_totalprice takeoutList:_shoppingCartArray];
