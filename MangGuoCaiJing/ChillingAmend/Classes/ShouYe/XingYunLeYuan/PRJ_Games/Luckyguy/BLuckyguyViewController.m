...
//
//        socialData.shareText =   [NSString stringWithFormat:@"小伙伴们,我正在参与辣椒圈app里的幸运转盘,快来辣椒圈跟我一起转出大奖吧~(来自于辣椒圈App) http://cqtv.sinosns.cn/"];
//
//    }
//
//}
...
{
    self.shareContent = @"什么??!!! 这个转盘里面竟然有我一直想要的...简直不敢相信!! 快来围观!!! http://mgcj.sinosns.cn/";
    [self callOutShareViewWithUseController:self andSharedUrl:@"http://mgcj.sinosns.cn/"];
}
