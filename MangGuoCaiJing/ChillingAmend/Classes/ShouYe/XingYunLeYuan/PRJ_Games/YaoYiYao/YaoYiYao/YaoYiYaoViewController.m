...
- (IBAction)UbuttonSender:(UIButton *)sender
{
    ...
    switch (sender.tag) {
        ...
        case 5://帮助
        {
            self.rulesTextView.text = @"关注湖南广播电视台广播传媒中心经济频道精彩节目，积极参与有奖互动！赶快来赢取您的超级大奖吧！";
...
- (void) shareDefalutMessage
{
    ...
    self.shareContent = [NSString stringWithFormat:@"小伙伴们,我在使用芒果财经app中摇一摇呢~ 快来芒果财经跟我一起摇出大奖吧 (来自于芒果财经App) http://mgcj.sinosns.cn/"];
}
