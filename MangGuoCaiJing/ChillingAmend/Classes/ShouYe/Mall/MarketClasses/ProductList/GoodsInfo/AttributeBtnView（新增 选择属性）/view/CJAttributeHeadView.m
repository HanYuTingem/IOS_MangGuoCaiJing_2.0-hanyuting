...
- (void)drawRect:(CGRect)rect
{
    ...
    //[url ]
    [self.iconImage sd_setImageWithURL:[NSURL URLWithString:[url stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]] placeholderImage:[UIImage imageNamed:@"list_placeholder.png"]];
